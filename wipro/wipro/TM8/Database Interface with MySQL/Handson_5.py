...
while(1):
    ...
    if n==0:
        ...
        cur.execute("INSERT INTO STUDENT values({},\'{}\',\'{}\')".format(roolno,name,adress))
        count+=1
        ...
        cur.execute("INSERT INTO MARKS(EXAMID,ROLLNO,M1,M2,M3) VALUES(%s,%s,%s,%s,%s)",(examid,rollno,m1,m2,m3))
        count1+=1
